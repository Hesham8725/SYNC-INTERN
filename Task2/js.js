...
function ShowQuestions(val) {
  if(count+1==QuestionData.results.length){
    ...
    if (QuestionData.results[count].type == "boolean") {
      ...
      document.getElementById("QuestionTFh").innerText = QuestionData.results[count].question;
      document.getElementById("Option1TF").innerText = "True";
      document.getElementById("Option2TF").innerText = "False";
    }
    else {
      ...
      document.getElementById("Question").innerText = QuestionData.results[count].question;
      document.getElementById("Option1").innerText = QuesValue[arr[0]];
      document.getElementById("Option2").innerText = QuesValue[arr[1]];
      document.getElementById("Option3").innerText = QuesValue[arr[2]];
      document.getElementById("Option4").innerText = QuesValue[arr[3]];
    }
  }
